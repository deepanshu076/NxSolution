...
const productsData = {
  ...
  access: [
    {
      ...
      desc: "High-precision fingerprint & hand geometry entry.",
      image:
        "https://images.unsplash.com/photo-1554224155-1696413565d3?w=600&q=80",
      category: ["security", "ai", "automation"],
    },
    {
      type: "hardware",
      name: "Face Recognition Terminals",
      desc: "Contactless AI detection with anti-spoofing.",
      image:
        "https://images.unsplash.com/photo-1593583853246-8e503375862f?w=600&q=80",
      category: ["security", "ai", "automation"],
    },
    {
      type: "hardware",
      name: "RFID Card Readers",
      desc: "Long-range and encrypted frequency readers.",
      image:
        "https://images.unsplash.com/photo-1624397648248-9a98f7f01e53?w=600&q=80",
      category: ["security", "automation"],
    },
    {
      type: "hardware",
      name: "Smart Turnstile Gates",
      desc: "Industrial-grade tripod and flap barriers.",
      image:
    ...
    {
      type: "hardware",
      name: "Boom Barrier Systems",
      desc: "Automated vehicle entry with high-speed motor.",
      image:
    ...
    },
    {
      ...
      desc: "Cloud-connected locks for granular room access.",
      image:
        "https://images.unsplash.com/photo-1631541909061-71e349d1f3b3?w=600&q=80",
      category: ["security", "automation"],
    },
    {
      type: "solution",
      name: "QR Code Access Systems",
      desc: "Mobile-first temporary access for visitors.",
      image:
    ...
    {
      type: "solution",
      name: "Cloud Access Controller",
      desc: "Manage all entry points from a single web dashboard.",
      image:
        "https://images.unsplash.com/photo-1558494949-ef010ca68a9c?w=600&q=80",
      category: ["cloud", "saas"],
    },
  ],
  // Attendance
  attendance: [
    {
      type: "hardware",
      name: "Biometric Attendance Machines",
      desc: "Fast reporting and shift management integration.",
      image:
        "https://images.unsplash.com/photo-1554224155-1696413565d3?w=600&q=80",
      category: ["security", "automation"],
    },
    {
      type: "hardware",
      name: "Face Recognition Attendance Systems",
      desc: "Group detection for classroom and office entries.",
      image:
        "https://images.unsplash.com/photo-1593583853246-8e503375862f?w=600&q=80",
    ...
    {
      type: "solution",
      name: "Mobile Attendance Apps (GPS-based)",
      desc: "Geofencing based presence tracking for remote teams.",
      image:
        "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=600&q=80",
      category: ["saas", "cloud", "analytics"],
    },
    {
      type: "hardware",
      name: "Smart Attendance Kiosks",
      desc: "Self-service kiosks for staff and visitors.",
      image:
    ...
    {
      type: "solution",
      name: "Payroll Integration Suite",
      desc: "Automatically sync attendance logs with accounting software.",
      image:
        "https://images.unsplash.com/photo-1454165833267-0e6988448a3e?w=600&q=80",
  ...
  surveillance: [
    {
      ...
      desc: "On-edge processing for object and face detection.",
      image:
        "https://images.unsplash.com/photo-1557597774-9d2739f05a76?w=600&q=80",
      category: ["security", "ai", "analytics"],
    },
    {
      type: "hardware",
      name: "IP Surveillance Cameras",
      desc: "4K resolution with night vision and PoE support.",
      image:
        "https://images.unsplash.com/photo-1551817958-d143ea6f0df5?w=600&q=80",
      category: ["security"],
    },
    {
      type: "hardware",
      name: "PTZ Cameras (Pan-Tilt-Zoom)",
      desc: "Remote controlled tracking cameras.",
      image:
        "https://images.unsplash.com/photo-1559828589-72de70ca3738?w=600&q=80",
      category: ["security", "automation"],
    },
    {
      type: "solution",
      name: "Video Management Systems (VMS)",
      desc: "Centralized control software for all feeds.",
      image:
    ...
    },
    {
      ...
      desc: "High-capacity server storage for surveillance.",
      image:
        "https://images.unsplash.com/photo-1558494949-ef010ca68a9c?w=600&q=80",
      category: ["security"],
    },
    {
      type: "solution",
      name: "Smart Surveillance Analytics",
      desc: "AI analytics for perimeter security and breach detection.",
      image:
  ...
  intelligence: [
    {
      type: "solution",
      name: "AI-Based Monitoring Systems",
      desc: "Predictive analytics for anomaly detection.",
      image:
        "https://images.unsplash.com/photo-1507146426996-ef05306b995a?w=600&q=80",
      category: ["ai", "analytics", "security"],
    },
    {
      type: "hardware",
      name: "Intrusion Detection Systems",
      desc: "Vibration and perimeter breach sensors.",
      image:
        "https://images.unsplash.com/photo-1558494949-ef010ca68a9c?w=600&q=80",
      category: ["security"],
    },
    {
      ...
      desc: "Multi-zone alerts with app notifications.",
      image:
    ...
    {
      type: "hardware",
      name: "Panic Button Devices",
      desc: "Instant emergency triggering for security staff.",
      image:
        "https://images.unsplash.com/photo-1517077304055-6e89a382830f?w=600&q=80",
      category: ["security"],
    },
    {
      type: "hardware",
      name: "Emergency Alert Systems",
      desc: "Visual and audio mass notification units.",
      image:
        "https://images.unsplash.com/photo-1454165833267-0e6988448a3e?w=600&q=80",
      category: ["security"],
    },
  ...
  parking: [
    {
      type: "hardware",
      name: "Automated Boom Barriers",
      desc: "High-speed Entry/Exit vehicle hurdles.",
      image:
        "https://images.unsplash.com/photo-1510915228340-29c85a43dcfe?w=600&q=80",
      category: ["automation"],
    },
    {
      type: "hardware",
      name: "RFID Vehicle Access Tags",
      desc: "Windshield tags for seamless gate entry.",
      image:
    ...
    {
      type: "hardware",
      name: "Smart Parking Sensors",
      desc: "Ultrasonic sensors for slot occupancy.",
      image:
        "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=600&q=80",
    ...
    },
    {
      ...
      desc: "Directional LED systems for vacant slot finding.",
      image:
    ...
    {
      type: "solution",
      name: "License Plate Recognition (ANPR) Systems",
      desc: "AI cameras for automated logging.",
      image:
        "https://images.unsplash.com/photo-1557597774-9d2739f05a76?w=600&q=80",
      category: ["ai", "security", "analytics"],
    },
  ],
  // Assets
  assets: [
    {
      type: "hardware",
      name: "RFID Asset Tracking Tags",
      desc: "Metal-mount and flexible tags for equipment.",
      image:
        "https://images.unsplash.com/photo-1586528116311-ad8619bc9141?w=600&q=80",
      category: ["automation"],
    },
    {
      type: "hardware",
      name: "GPS Tracking Devices",
      desc: "Real-time location for transit and fleet.",
      image:
        "https://images.unsplash.com/photo-1533035353112-9c42c2627402?w=600&q=80",
      category: ["automation", "analytics"],
    },
    {
      type: "hardware",
      name: "BLE Tracking Beacons",
      desc: "Indoor positioning and proximity triggers.",
      image:
    ...
    {
      type: "solution",
      name: "Smart Inventory Tracking Systems",
      desc: "Live stock monitoring and automated audits.",
      image:
        "https://images.unsplash.com/photo-1586528116311-ad8619bc9141?w=600&q=80",
      category: ["cloud", "analytics"],
    },
    ...
    >
      ...
      <div className="aspect-16/10 sm:aspect-4/3 overflow-hidden relative shrink-0">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0 bg-linear-to-t from-brand-black/40 via-transparent to-transparent opacity-80" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                return (
                  ...
                  >
                    <Icon
                      size={16}
                      className={
                        isActive ? "text-soft-white" : "text-brand-black/40"
                      }
                    />
                    {category.label}
                  </button>
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-20 px-4">
              ...
              <p className="text-brand-black/50 text-base sm:text-lg">
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-brand-black text-center relative overflow-hidden px-4 sm:px-6">
        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-soft-white mb-6 leading-tight">
            Build a Complete Smart System <br className="hidden sm:block" /> for
            Your Operations
          </h2>
          <p className="text-soft-white/60 text-sm sm:text-base lg:text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
            Tell us your operational challenges — we'll design the right system
            around them.
          </p>
