      ...
      <section className="py-10 md:py-16 bg-gray-50 border-b border-gray-200">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          ...
          <div className="mb-10 md:mb-14 text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-2xl md:text-4xl font-display font-bold text-brand-black leading-tight">
          ...
          {/* Solutions Grid Area */}
          <div className="bg-white rounded-[2rem] border border-gray-200 overflow-hidden shadow-xl p-6 md:p-10 lg:p-12">

            <div className="text-center mb-8 md:mb-10">
              <h3 className="text-xl md:text-3xl font-display font-bold text-brand-black mb-3 capitalize">
