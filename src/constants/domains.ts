...
export const domainsData: Domain[] = [
  {
    ...
    name: "Education",
    slug: "education",
    description: "Smart solutions for educational institutions",
    icon: "🎓",
    color: "#3B82F6",
    image_url: null,
    order_index: 1,
  ...
  },
  {
    ...
    name: "Healthcare",
    slug: "healthcare",
    description: "Intelligent systems for healthcare facilities",
    icon: "🏥",
    color: "#EF4444",
    image_url: null,
    order_index: 2,
  ...
  },
  {
    ...
    name: "Manufacturing",
    slug: "manufacturing",
    description: "IoT solutions for industrial operations",
    icon: "🏭",
    color: "#F59E0B",
    image_url: null,
    order_index: 3,
  ...
  },
  {
    ...
    name: "Corporate",
    slug: "corporate",
    description: "Enterprise solutions for offices and businesses",
    icon: "🏢",
    color: "#8B5CF6",
    image_url: null,
    order_index: 4,
...
export const subdomainsData: Subdomain[] = [
  // Education subdomains
  {
    ...
    name: "Security",
    slug: "security",
    description: "Campus safety and access control",
    icon: "🔐",
    order_index: 1,
    is_active: true,
    created_at: null,
  ...
  },
  {
    ...
    slug: "equipment",
    description: "Medical device tracking",
    icon: "🔬",
    order_index: 2,
    is_active: true,
    created_at: null,
  ...
  // Corporate subdomains
  {
    ...
    name: "Access Control",
    slug: "access",
    description: "Office entry and security",
    icon: "🔑",
    order_index: 1,
    is_active: true,
    created_at: null,
...
export const subdomainsMap: Record<string, string[]> = {
  ...
  "Coaching Institutes": [
    "Main Entrance / Entry Area",
    "Reception / Front Desk",
    "Waiting Area",
    "Admin Office",
    "Faculty Cabins",
    "Classrooms",
    "Computer Lab / Test Room",
    "Student Help Desk",
  ...
  Offices: [
    "Main Entrance / Entry Area",
    "Reception / Front Desk",
    "Workstations / Open Workspace",
    "Meeting Rooms",
    "Conference Rooms",
    "Manager / Executive Cabins",
    "HR / Admin Office",
    "Server Room / IT Room",
  ...
  Startups: [
    ...
    "Open Workspaces",
    "Collaboration / Discussion Zones",
    "Meeting Rooms",
    "Founder / Core Team Area",
    "Flexible Work Pods",
  ...
  "Government Offices": [
    ...
    "Visitor Entry & Verification Area",
    "Reception / Help Desk",
    "Waiting Area (Public)",
    "Public Service Counters",
    "Officer Cabins / Departments",
    "Admin Office",
    "Records / Document Storage Room",
  ...
  Airports: [
    ...
    "Parking / Transport Area",
  ],
  Factories: [
    "Entry Gate / Security Gate",
    "Worker Entry & Checkpoint",
    "Production Floor",
    "Assembly Line Area",
    "Storage / Inventory Area",
    "Raw Material Area",
    "Dispatch / Loading Area",
    "Supervisor Cabin",
    "Control Room",
    "Safety / Compliance Area",
    "Utility / Maintenance Area",
  ...
  "Gated Communities": [
    ...
    "Maintenance / Utility Area",
    "Perimeter / Boundary Area",
  ],
  "Housing Societies": [
    "Main Gate / Entry Gate",
    "Visitor Entry & Security Check",
    "Security Cabin / Guard Room",
    "Building Entry / Tower Entry",
    "Lift Lobby",
    "Parking Area",
    "Resident Units / Flats",
    "Community Hall",
    "Garden / Open Area",
    "Children Play Area",
    "Maintenance Office",
  ...
  Apartments: [
    "Main Gate / Entry Gate",
    "Visitor Entry & Security Checkpoint",
    "Reception / Security Desk",
    "Tower / Building Entry",
    "Lift Lobby",
    "Parking Area",
    "Resident Flats / Units",
...
export const domains = domainNames.map((name, index) => {
  ...
  return {
    ...
    description: `${name} solutions for secure access, monitoring, and operational automation.`,
    sub: subdomainsMap[name]
      ? subdomainsMap[name].join(" · ")
      : "Smart · Integrated · Monitored",
