...
const problems = [
  {
    ...
    subtitle: "Manual checks & queues",
    desc: "Long queues and manual gate checks slow down throughput, causing frustration and time loss across shifts.",
    image: "/images/smart access system.jpeg",
  },
  {
    id: "02",
    title: "Attendance Inaccuracy",
    subtitle: "Proxy & unreliable logs",
    desc: "Manual registers and proxy entries make attendance unreliable, leading to payroll errors and audit risks.",
    image: "/images/attendance system.jpeg",
  },
  {
    id: "03",
    title: "Unauthorized Access",
    subtitle: "Untracked entry risks",
    desc: "Lack of proper control allows untracked and unsafe movement, compromising the security of restricted zones.",
    image: "/images/smart access system.jpeg",
  },
  {
    id: "04",
    title: "Weak Surveillance",
    subtitle: "Reactive monitoring only",
    desc: "Incidents are often noticed only after they occur due to blind spots and lack of predictive surveillance.",
    image: "/images/survillance monitoring.jpeg",
  },
  {
    id: "05",
    title: "No Real-Time Visibility",
    subtitle: "Lag in operational data",
    desc: "Critical decisions are delayed because managers lack a live, integrated view of what is happening on the ground.",
    image: "/images/security intelligence.jpeg",
  },
  {
    id: "06",
    title: "Untracked Movement",
    subtitle: "Blind asset & people flow",
    desc: "No clear visibility of people, vehicles, or asset movement, leading to operational leakage and security gaps.",
    image: "/images/survillance monitoring.jpeg",
  },
  {
    id: "07",
    title: "Resource & Energy Waste",
    subtitle: "Uncontrolled consumption",
    desc: "Uncontrolled usage of water, electricity, and hardware increases operational costs and environmental impact.",
    image: "/images/energy optimization.jpeg",
  },
  {
    id: "08",
    title: "Disconnected Systems",
    subtitle: "Siloed tools confusion",
    desc: "Multiple tools without integration create confusion, data duplication, and extreme workflow inefficiency.",
    image: "/images/workflow automation.jpeg",
  },
  {
    id: "09",
    title: "Manual Processes",
    subtitle: "Error-prone dependencies",
    desc: "Heavy dependence on manual work leads to frequent human errors, delays, and lack of accountability.",
    image: "/images/workflow automation.jpeg",
  },
  {
    id: "10",
    title: "Poor Visitor Management",
    subtitle: "Chaotic guest tracking",
    desc: "Visitor entry and tracking are not streamlined, creating bottlenecks and security risks at the reception.",
    image: "/images/smart access system.jpeg",
  },
  {
    id: "11",
    title: "Lack of Central Control",
    subtitle: "No unified command",
    desc: "No single platform to monitor and manage operations across multiple sites or departments simultaneously.",
    image: "/images/security intelligence.jpeg",
  },
  {
    id: "12",
    title: "Delayed Issue Detection",
    subtitle: "Slow incident response",
    desc: "Problems are identified too late, increasing their impact and the cost of resolution exponentially.",
    image: "/images/security intelligence.jpeg",
  },
];
...
export default function OperationalChallenges() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(150deg,#fffcf5 0%,#fef8e8 45%,#fdf3d8 100%)",
      }}
    >
      <div className="container mx-auto px-4 md:px-6 max-w-6xl w-full">
        <div className="text-center mb-6 md:mb-10 lg:mb-14 max-w-2xl mx-auto">
          <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-display font-bold text-brand-black mb-2 md:mb-3">
            Operational Challenges
          </h2>
          <p className="text-charcoal/60 text-xs md:text-sm lg:text-lg">
            Friction points we eliminate through high-performance automation
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          ...
          <div className="w-full lg:w-3/5 order-1 lg:order-2 flex justify-center items-center">
            <div className="relative h-80 md:h-[500px] w-full rounded-[2.5rem] bg-brand-black overflow-hidden group/visual shadow-2xl border-6 md:border-8 border-soft-white">
              <motion.div
                key={activeProblem}
              ...
              >
                <img
                  ...
                  className="w-full h-full object-cover opacity-90 transition-transform duration-2000 group-hover/visual:scale-105"
            ...
            <div className="flex flex-row lg:flex-col gap-3 min-w-max lg:min-w-0 pb-4 lg:pb-0">
              {problems.map((prob, i) => (
                <button
                  key={prob.id}
                  onMouseEnter={() =>
                    window.innerWidth > 1024 && setActiveProblem(i)
                  }
                  onClick={() => setActiveProblem(i)}
                  className={`group relative px-5 py-4 lg:px-6 lg:py-5 rounded-2xl transition-all duration-500 border flex flex-col gap-0.5 text-left shrink-0 w-60 lg:w-full ${
                    activeProblem === i
                ...
                >
                  <div
                    className={`text-[9px] uppercase tracking-[.2em] font-bold mb-0.5 transition-colors ${activeProblem === i ? "text-warm-gold-beige/60" : "text-brand-walnut/40"}`}
                  >
                    Problem {prob.id}
                  </div>
                  ...
                  <p
                    className={`text-[10px] font-medium transition-colors ${activeProblem === i ? "text-soft-white/60" : "text-charcoal/50"}`}
                  >
                    {prob.subtitle}
                  </p>
                  <ChevronRight
