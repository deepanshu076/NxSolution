...
export default function OperationalChallenges() {
  ...
  return (
    ...
    <section className="py-10 md:py-16 lg:py-20 overflow-hidden" style={{ background: "var(--nx-ice)" }}>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl w-full">
        ...
        <div className="text-center mb-6 md:mb-10 lg:mb-14 max-w-2xl mx-auto">
          ...
          <h4 className="text-nx-navy font-bold text-[10px] md:text-xs tracking-[0.3em] uppercase mb-3 opacity-80">

            Problems

          </h4>

          <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-display font-bold text-nx-navy mb-2 md:mb-3">Operational Challenges</h2>

          <p className="text-nx-steel/60 text-xs md:text-sm lg:text-lg">Problems we eliminate through high-performance automation</p>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          ...
          <div className="w-full lg:w-3/5 order-1 lg:order-2 flex justify-center items-center">
            ...
            <div className="relative h-[320px] md:h-[500px] w-full rounded-[2.5rem] bg-nx-navy overflow-hidden group/visual shadow-2xl border-6 md:border-8 border-soft-white">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-nx-navy via-nx-navy/30 to-transparent" />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                  ...
                  <div className="space-y-2 md:space-y-4">
                    ...
                    <div className="w-10 h-1 bg-nx-navy rounded-full mb-3 md:mb-6" />

                    <h3 className="text-xl md:text-4xl font-display font-bold text-nx-white leading-tight">
                    ...
                    <div className="hidden lg:block max-h-0 opacity-0 group-hover/visual:max-h-[200px] group-hover/visual:opacity-100 transition-all duration-700 ease-[0.19,1,0.22,1] overflow-hidden">
                      ...
                      <p className="text-nx-white/80 text-sm md:text-lg leading-relaxed max-w-2xl pt-4">
                    ...
                    <div className="pt-4 group-hover/visual:opacity-0 transition-opacity duration-300 hidden lg:block">
                      ...
                      <span className="text-[9px] font-bold uppercase tracking-[.4em] text-nx-ice/60 flex items-center gap-2">

                        <div className="w-1.5 h-1.5 rounded-full bg-nx-navy animate-pulse" />
          ...
          <div
            ...
            className="w-full lg:w-2/5 order-2 lg:order-1 h-auto lg:h-[500px] overflow-x-auto lg:overflow-y-auto lg:overflow-x-hidden pr-0 lg:pr-4
               ...
               [&::-webkit-scrollbar-track]:bg-nx-navy/5 shadow-inner [&::-webkit-scrollbar-track]:rounded-full

               [&::-webkit-scrollbar-thumb]:bg-nx-navy/20 hover:[&::-webkit-scrollbar-thumb]:bg-nx-navy/40 [&::-webkit-scrollbar-thumb]:rounded-full transition-colors"
              ...
              {problems.map((prob, i) => {
                ...
                return (
                  ...
                  <button
                    ...
                    className={`group relative px-5 py-4 lg:px-6 lg:py-5 rounded-2xl transition-all duration-500 border flex flex-col gap-0.5 text-left shrink-0 w-[240px] lg:w-full ${isActive

                      ? "bg-white border-nx-white shadow-xl shadow-nx-navy/5 scale-[1.01] z-10"

                      : "bg-nx-white/50 border-nx-steel/10 hover:bg-white hover:border-nx-navy/20"

                      }`}

                  >

                    <div className={`text-[9px] uppercase tracking-[.2em] font-bold mb-0.5 transition-colors ${isActive ? "text-nx-navy/60" : "text-nx-navy/40"}`}>

                      Problem {prob.id}

                    </div>

                    <h4 className={`font-display font-bold text-sm md:text-base leading-tight transition-colors ${isActive ? "text-nx-navy" : "text-nx-navy/80 group-hover:text-nx-navy"}`}>

                      {prob.title}

                    </h4>

                    <p className={`text-[10px] font-medium transition-colors ${isActive ? "text-nx-steel" : "text-nx-steel/60 group-hover:text-nx-steel"}`}>
                    ...
                    <ChevronRight
                      ...
                      className={`absolute right-4 top-1/2 -translate-y-1/2 transition-all duration-500 hidden lg:block ${isActive ? "translate-x-1 opacity-100 text-nx-navy" : "opacity-0 group-hover:opacity-100 text-nx-navy/40"
